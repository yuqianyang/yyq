    ...
    <div class="user-click">
        <ul class="nav navbar-nav">
            <li class="dropdown"><a href="#" class="dropdown-toggle"
                                    data-toggle="dropdown" style="color: white;"> <span
                    class="glyphicon glyphicon-user"></span>欢迎,
    ...
    <div class="leftscan"
        ...
        <ul style="list-style: none; color: #1963aa;">
            <c:if test="${sessionScope.user.role!=3 }">
                <li><a href="${APP_PATH }/index/toindex?tag=0"><span class="glyphicon glyphicon-log-in"></span>
                    停车位管理</a></li>
            </c:if>
            <li><a id="depotcardIndex" href="${APP_PATH }/index/toDepotcardIndex" target="main"
                   onclick="$('div#main').load(this.href);return false;"><span
                    class="glyphicon glyphicon-credit-card"></span> 停车卡管理</a></li>
            <li><a href="${APP_PATH }/index/findAllCoupon" target="main"
                   onclick="$('div#main').load(this.href);return false;"><span
                    class="	glyphicon glyphicon-usd"></span> 优惠券管理</a></li>
            <li><a href="${APP_PATH }/index/findAllEmail" target="main"
                   onclick="$('div#main').load(this.href);return false;"><span
                    class="	glyphicon glyphicon-send"></span> 邮箱管理</a></li>
            <li><a href="${APP_PATH }/index/findAllIllegalinfo" target="main"
                   onclick="$('div#main').load(this.href);return false;"><span
                    class="glyphicon glyphicon-th-large"></span> 违规管理</a></li>
            <c:if test="${sessionScope.user.role==1 }">
                <li><a href="${APP_PATH }/index/findAllIncome" target="main"
                       onclick="$('div#main').load(this.href);return false;"><span
                        class="glyphicon glyphicon-yen"></span> 收入管理</a></li>
            </c:if>
            ...
            <li><a href="${APP_PATH }/index/findAllDepot" target="main"
                   onclick="$('div#main').load(this.href);return false;"><span class="glyphicon glyphicon-tags"></span>
                历史停车</a></li>
            <c:if test="${sessionScope.user.role==1 }">
                <li><a href="${APP_PATH }/index/system" target="main"
                       onclick="$('div#main').load(this.href);return false;"><span
                        class="	glyphicon glyphicon-circle-arrow-down"></span> 导出功能</a></li>
            </c:if>
    ...
    <div id="main"
        ...
        <c:if test="${sessionScope.user.role!=3 }">
                    ...
                    <tr>
                        ...
                        <td><c:if test="${item.status==0 }">
                            ...
                            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#fileModal"
                                    onclick="fileUpload(${item.parkid})">
                                自动入库
                            </button>
                        ...
                        <td><input class="btn btn-default" type="button" onclick="checkDetail(${item.parkid})"
                                   value="查看"></td>
                    </tr>
                </c:forEach>
            </table>
            <ul class="pagination">
                ...
                <li><a href="${APP_PATH }/index/toindex?tag=${parkspaces.tag}&&page=${parkspaces.current}">&laquo;</a>
                </li>
                <li>
                    <a href="${APP_PATH }/index/toindex?tag=${parkspaces.tag}&&page=${parkspaces.current+1}">${parkspaces.current+1}</a>
                </li>
                <c:if test="${parkspaces.current+1>=parkspaces.countPage}">
                    <li>
                        <a href="${APP_PATH }/index/toindex?tag=${parkspaces.tag}&&page=${parkspaces.current+1}">&raquo;</a>
                    </li>
                </c:if>
                <c:if test="${parkspaces.current+1<parkspaces.countPage}">
                    <li>
                        <a href="${APP_PATH }/index/toindex?tag=${parkspaces.tag}&&page=${parkspaces.current+2}">&raquo;</a>
                    </li>
                </c:if>
            </ul>
        </c:if>
